...
static constexpr auto s_tag = "[DatasetValidationTool_Tree]";

TEST_CASE("Standard checks of DatasetValidationTool_Tree", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("DatasetValidationTool_Tree"
